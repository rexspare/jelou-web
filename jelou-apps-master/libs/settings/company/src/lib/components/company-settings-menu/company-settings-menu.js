...
export function CompanySettingsMenu(props) {
                                    ...
                                    <Disclosure.Panel>
                                        <Tab.List>
                                            <Tab
                                                ...
                                                onClick={() => {
                                                    handleChangeSection(COMPANY_SETTINGS.GENERAL);
                                                }}
                                            >
                                                {({ selected }) => (
                                                    <div
                                                        className={`flex w-full items-center border-b-0.5 border-y-gray-5 px-5 py-6 ${
                                                            sectionMatch(COMPANY_SETTINGS.GENERAL) ? "border-r-5 border-x-primary-200 bg-teal-5" : null
                                                        }`}
                                                    >
                                                        <CheckCircleIcon
                                                            className={sectionMatch(COMPANY_SETTINGS.GENERAL) ? "text-gray-400" : "text-gray-400 text-opacity-65"}
                                                            width="1.2rem"
                                                            height="1.2rem"
                                                        />
                                                        <p
                                                            className={`ml-4 truncate text-base font-bold ${
                                                                sectionMatch(COMPANY_SETTINGS.GENERAL) ? "text-gray-400" : "text-gray-400 text-opacity-65"
                                                            }`}
                                                        >
                                                            {t("General")}
                                                        </p>
