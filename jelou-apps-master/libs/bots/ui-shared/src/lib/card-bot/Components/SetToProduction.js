...
const SetToProduction = (props) => {
    const { onConfirm, onClose, loading, errors, state } = props;
    const ref = useRef();
                ...
                <div className="mb-3 flex items-center justify-between pb-4">
                    <div className="flex items-center">
                        ...
                        <div className="max-w-md text-xl font-bold text-gray-400">
                            {state ? t("setToProduction.productionTitle") : t("setToProduction.sandboxTitle")}
                        </div>
                    </div>
                ...
                <div className="relative">
                    <div>
                        <div className="mx-auto w-full max-w-sm px-5 pb-5">
                            <div className="mb-4">
                                <div className="text-center text-lg text-gray-400 text-opacity-75">{t("setToProduction.verifyProduction")}</div>
                            </div>
...
export default SetToProduction;
