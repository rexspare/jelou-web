...
const EmailActionsFilters = (props) => {
            ...
            <div className="flex w-full items-center space-x-6">
                ...
                <div className="flex h-[2.2rem] items-center space-x-4 border-r-[.1rem] border-gray-200 pr-5">
                    <Tippy theme={"tomato"} content={t("pma.Refrescar")} arrow={false}>
                        ...
                        >
                            <RefreshIcon1 height="1.25rem" width="1.25rem" className="text-gray-425 hover:text-gray-500" />
                        </div>
                    </Tippy>
...
export default EmailActionsFilters;
