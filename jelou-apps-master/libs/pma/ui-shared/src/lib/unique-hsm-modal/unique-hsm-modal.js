...
import { AlertIcon, CloseIcon1 } from "@apps/shared/icons";
...
const HsmModal = (props) => {
    const { openModal = false, closeModal = () => null, className = "max-w-7xl rounded-md", classNameActivate = "" } = props;
    ...
    const [phoneNumber, setPhoneNumber] = useState(get(currentArchivedRoom, "user.id", ""));

    const fileType = get(mediaUrl, "type", null);
    const successMessage = t("pma.Tu mensaje ha sido enviado correctamente.");
    ...
    return (
        <Transition appear show={openModal} as={Fragment}>
            <Dialog as="div" className="fixed inset-0 z-100 overflow-y-auto pl-[5.2rem]" onClose={closeModal}>
                <div className="min-h-screen px-4 text-center">
                    ...
                    <Transition.Child
                        ...
                        <section
                            className={`relative inline-block transform overflow-hidden rounded-20 bg-white text-left align-middle text-gray-400 shadow-xl transition-all ${className} ${classNameActivate}`}>
                            <div className="h-full flex-row">
                                <header className={`right-0 top-0 flex items-center justify-between bg-primary-350 px-10 py-4`}>
                                    <div className="flex items-center gap-x-4">
                                        <div className="text-base font-semibold text-primary-200">{t("pma.Contactar usuario")}</div>
                                    </div>
                                        ...
                                        <div className="flex flex-col space-y-2 p-4 sm:space-x-4 sm:space-y-0 sm:p-8 md:flex-row">
                                            <div className={`mb-2 w-full pl-2 sm:pl-4 md:w-auto md:min-w-350 ${hasMoreBots && "md:mr-8"}`}>
                                                {hasMoreBots && (
                                                    <div className="flex flex-col pb-8 md:pb-16 mid:w-325">
                                                        <label className="block pb-2 text-sm font-bold text-gray-400 sm:text-base md:pb-6">
                                                            {t("pma.Seleccione bot")}
                                                        </label>
                                                        <SelectSearch
                                                ...
                                                {!isEmpty(hsm) && !isEmpty(flows) && (
                                                    <div>
                                                        <label className="block pb-2 text-sm font-bold text-gray-400 sm:text-base md:pb-6">
                                                            {t("pma.Seleccione flujo (Opcional)")}
                                                        </label>
                                                        <SelectSearch
                                                    ...
                                                    <>
                                                        <div className="mt-10 flex">
                                                            <p className="text-sm font-bold text-gray-400 sm:text-base">
                                                                {t("pma.changeOrUpload")}{" "}
                                                                <span>{t(`selectMessage.${fileType.toLowerCase()}`).toLowerCase()}</span>
                                                            </p>
                                                        </div>
                                                                ...
                                                                <div className="flex min-h-[7.5rem] w-full overflow-hidden rounded-xl border-1 border-[#CDD7E7] p-3">
                                                                    ...
                                                                    <div className="flex flex-col items-center justify-center">
                                                                        <input
                                                                            ...
                                                                            type="file"
                                                                            name="avatar"
                                                                            accept={inputAcceptType(fileType)}
                                                                            onChange={handleDocFile}
                                                                            id="file-picker"
                                                                        />
                                                                        <p className="pl-4 text-xs font-bold  text-gray-400">
                                                                            {t("selectMessage.searchFile")}{" "}
                                                                        </p>
                                                                        {!loadingMedia && (
                                                                            <button
                                                                                ...
                                                                                {t(`selectMessage.${fileType.toLowerCase()}`).toLowerCase()}
                                                                            </button>
                                                                        )}
                                                                        {loadingMedia && (
                                            ...
                                            <div className={`flex flex-col pl-2 ${hasMoreBots && "md:pl-4"}`}>
                                                <div className="mb-8 flex flex-col md:w-325 md:pb-8">
                                                    <label className="mb-1 block text-sm font-bold text-gray-400 sm:text-base md:mb-6">
                                                        {t("pma.Elige la plantilla")}
                                                    </label>
                                                    {isLoading ? (
                                                        ...
                                                        <div className="mb-16 flex flex-row items-center border-b-default border-gray-35">
                                                            <div className="mr-2 flex h-10 w-full items-center truncate py-2 text-15 font-normal text-gray-450 ">
                                                                {t("pma.No se encontró hsm")}
                                                            </div>
                                                        </div>
                                                    ) : (
                                                        <div className="mb-16 flex flex-row items-center border-b-default border-gray-35">
                                ...
                                <div className="bg-modal-footer flex w-full items-center justify-center rounded-b-lg px-4 pb-4 sm:px-8 md:justify-end md:pb-8">
                                    ...
                                    <button
                                        ...
                                        disabled={!(!hsmError && !hasParams.value && !isEmpty(hsm))}
