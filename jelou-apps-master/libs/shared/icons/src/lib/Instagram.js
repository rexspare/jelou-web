...
const Instagram = (props) => (
  ...
  >
    ...
    >
      ...
      <stop offset="0.2412" style={{ stopColor: '#E48242' }} />
      <stop offset="0.3463" style={{ stopColor: '#D66863' }} />
      <stop offset="0.4422" style={{ stopColor: '#CD4F74' }} />
      <stop offset="0.4888" style={{ stopColor: '#C94379' }} />
      <stop offset="1" style={{ stopColor: '#3F56A6' }} />
    </radialGradient>
    <path
      id="XMLID_1418_"
      fill="url(#XMLID_2_)"
      d="M38.2,72.8L38.2,72.8C18.4,72.8,2.4,56.8,2.4,37l0,0c0-19.8,16.1-35.9,35.9-35.9h0
		C58,1.1,74.1,17.2,74.1,37l0,0C74.1,56.8,58,72.8,38.2,72.8z"
    />
    <path
      id="XMLID_1352_"
      fill="#FFFFFF"
      d="M38.2,20.9c5.3,0,5.9,0,7.9,0.1c1.9,0.1,3,0.4,3.7,0.7c0.9,0.4,1.6,0.8,2.3,1.5
    ...
    <path
      id="XMLID_1349_"
      fill="#FFFFFF"
      d="M38.2,26.9c-5.6,0-10.1,4.5-10.1,10.1c0,5.6,4.5,10.1,10.1,10.1
    ...
    <path
      id="XMLID_1348_"
      fill="#FFFFFF"
      d="M51.1,26.5c0,1.3-1.1,2.4-2.4,2.4c-1.3,0-2.4-1.1-2.4-2.4c0-1.3,1.1-2.4,2.4-2.4
