    ...
    return (
        <div
            ...
            <div className="relative w-full pl-1">
                <div className="nowrap w-full overflow-hidden text-15 font-bold text-gray-400">{user.names}</div>
                <dd className="nowrap w-full overflow-hidden text-13 font-medium text-gray-400">{user.email}</dd>
            </div>
        </div>
    );
};
